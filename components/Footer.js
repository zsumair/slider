    ...
    <>
      <footer className="footer p-10 bg-base-200 text-base-content rounded-md">
        <div>
          ...
          <a className="link link-hover">Prayers</a>
          <a className="link link-hover">Ramadan</a>
          <a className="link link-hover">Iftar</a>
          <a className="link link-hover">Suhoor</a>
        </div>
        <div>
          <span className="footer-title">Volunteer</span>
